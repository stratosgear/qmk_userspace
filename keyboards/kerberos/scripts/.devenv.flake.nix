{
  inputs =
    let
      version = "1.8.2";
system = "x86_64-linux";
devenv_root = "/projects/stratosgear/qmk_userspace/keyboards/kerberos/scripts";
devenv_dotfile = "/projects/stratosgear/qmk_userspace/keyboards/kerberos/scripts/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-4364ab2";
